...
class PackageVersionReportCommand {
                ...
                if (context.flags.json) {
                    ...
                    if (this.verbose) {
                        ...
                        if (coverageData == null) {
                            ...
                            codeCovStr = "Sorry! you're results are too big"; // Calculated code coverage data is too big to fit into a DB field. Retrieve it from the packageZip
                        }
                        else {
    ...
    getColumnData() {
        ...
        const columnData = this.haveCodeCoverageData === true
            ? {
                retRecord: [
                    { key: 'key', label: 'Name' },
                    { key: 'value', label: 'Value' },
                ],
                // table2: is used to display the code coverage data
                retCoverageRecord: [
                    { key: 'key', label: 'Class Name' },
                    { key: 'value', label: 'Coverage Percentage' },
                ],
            }
            : {
                retRecord: [
