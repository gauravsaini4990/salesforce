...
class Stash {
    ...
    static getKey(commandId) {
        ...
        if (!key) {
            throw core_1.SfdxError.create('@salesforce/plugin-source', 'stash', 'InvalidStashKey', [commandId]);
        }
        return key;
    }
    /**
    ...
    static getStashFile() {
        ...
        try {
            ...
            if (error.name === 'JsonParseError') {
                ...
                const invalidStashErr = core_1.SfdxError.create('@salesforce/plugin-source', 'stash', 'InvalidStashFile', [
                    corruptFilePath,
                ]);
