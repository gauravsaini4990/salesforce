...
class Retrieve extends sourceCommand_1.SourceCommand {
    ...
    resolveProjectPath() {
        try {
            return core_1.SfdxProject.getInstance().getDefaultPackage().fullPath;
        }
        catch (error) {
