...
class Open extends sourceCommand_1.SourceCommand {
    ...
    getTypeNameDefinitionByFileName(fsPath) {
        ...
        throw new core_1.SfdxError(`File not found: ${fsPath}`, 'FileNotFound');
    }
    ...
    async open(src) {
        ...
        if (!core_1.sfdc.isInternalUrl(url)) {
            try {
                ...
                throw core_1.SfdxError.create('@salesforce/plugin-source', 'open', 'SourceOpenCommandTimeoutError');
            }
        }
