...
class App extends Generator {
    ...
    install() {
        ...
        switch (this.type) {
            ...
            case 'plugin':
                ...
                devDependencies.push('@oclif/dev-cli@^1', '@oclif/plugin-help@^3', 'globby@^11');
                break;
            case 'sfdx-plugin':
                dependencies.push('@oclif/command@^1', '@oclif/config@^1', '@oclif/errors@^1', '@salesforce/command@^4', '@salesforce/core@^2');
                devDependencies.push('@oclif/dev-cli@^1', '@oclif/plugin-help@^3', 'globby@^11', '@salesforce/dev-config@^2', '@salesforce/dev-scripts@^0', '@salesforce/prettier-config@^0', '@salesforce/ts-sinon@^1', '@types/jsforce@^1.9.29', '@typescript-eslint/eslint-plugin@^4', '@typescript-eslint/parser@^4', 'eslint-config-prettier@^8', 'eslint-config-salesforce@^0', 'eslint-config-salesforce-typescript@^0', 'eslint-plugin-header@^3', 'eslint-plugin-import@^2', 'eslint-plugin-jsdoc@^35', 'eslint-plugin-prettier@^3', 'eslint-plugin-typescript@^0', 'husky@^4', 'prettier@^2', 'pretty-quick@^3');
                break;
            case 'multi':
                dependencies.push('@oclif/config@^1', '@oclif/command@^1', '@oclif/plugin-help@^3');
                devDependencies.push('@oclif/dev-cli@^1', 'globby@^11');
        }
        if (this.mocha) {
            devDependencies.push('mocha@^8', 'nyc@^15', 'chai@^4', 'sinon@10.0.0');
            if (this.type !== 'base')
                devDependencies.push('@oclif/test@^1');
        }
        if (this.ts) {
            dependencies.push('tslib@^2');
            devDependencies.push('ts-node@^10', 'typescript@4');
            if (this.mocha) {
                devDependencies.push('@types/chai@^4', '@types/mocha@^8');
            }
            if (this.tslint) {
                devDependencies.push('tslint@^6');
            }
        }
        if (this.eslint) {
            devDependencies.push('eslint@^7', 'eslint-config-oclif@^3.1');
        }
        if (isWindows)
    ...
    _writeSingle() {
        const bin = this._bin;
        const opts = { ...this, _, bin, cmd: bin, name: this.pjson.name };
