...
const getCurrentApiVersion = async () => (await (0, got_1.default)('https://mdcoverage.secure.force.com/services/apexrest/report', gotOptions).json()).versions.selected;
...
const getCoverage = async (apiVersion) => {
    ...
    [44, 45, 46].map(async (na) => await (0, got_1.default)(`https://na${na}.test1.pc-rnd.salesforce.com/mdcoverage/api.jsp`, gotOptions).json()));
