...
import { BasicRecord, Field, SoqlQueryResult } from './dataSoqlQueryTypes';
...
export declare class HumanReporter extends QueryReporter {
    ...
    soqlQuery(columns: Array<Optional<string>>, records: BasicRecord[], totalCount: number): void;
    prepNullValues(records: unknown[]): void;
    prepColumns(columns: Array<Optional<string>>): ColumnAttributes[];
    massageRows(queryResults: BasicRecord[], children: string[], aggregates: Field[]): BasicRecord[];
}
